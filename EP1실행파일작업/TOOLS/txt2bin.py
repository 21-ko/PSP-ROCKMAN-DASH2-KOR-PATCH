...
def txt_to_bin(input_file, base_offset, base_offset_2=None, plus=None):
    ...
    offset_table_size = (num_blocks + 1) * a
    block_offsets = []
...
def main():
    ...
    eboot_file = "dash2e1.prx"
    base_offset = 0x1f9bd0  # .data 위치
    base_offset_2 = 0x616B80
    max_pos = base_offset_2 + 0x8000-0x20
    next_data_offset = 0
    ...
    for input_file in txt_files:
        ...
        with open(eboot_file, "rb+") as f:
            ...
            if len(binary_data) <= size:
                ...
                if data_write_position >= max_pos:
                    print("error!")
                    sys.exit(1)
